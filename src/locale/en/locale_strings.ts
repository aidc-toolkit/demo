export const localeStrings = {
    ...
    String: {
        ...
        minimumLengthText: "If provided, the minimum length of the {{name, lowercase}} string.",
        maximumLengthLabel: "Maximum length",
        maximumLengthText: "If provided, the maximum length of the {{name, lowercase}} string.",
        createSubtitle: "Create",
        valueLabel: "Value",
        valueText: "Numeric value to be converted to {{name, lowercase}} string.",
        createSequenceSubtitle: "Create sequence",
        startValueLabel: "Start value",
        startValueText: "Start of numeric values to be converted to {{name, lowercase}} strings.",
        countLabel: "Count",
        countText: "Count of numeric values to be converted to {{name, lowercase}} strings.",
        valueSubtitle: "Value",
